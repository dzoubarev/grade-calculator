...
public class GradeCalcController{
    ...
    @PutMapping("/change/scheme")
    public ResponseEntity<String> changeScheme(@RequestBody List<GradingSchemeDTO> newSchemes){
        gradeCalcService.updateSectionsInGradingScheme(newSchemes);
        return ResponseEntity.ok("All schemes have been saved");
    }
}